...
Public Class SlimOS_Form
    ...
    Public ReadOnly Property WindowState As SWindowState
        Get
            Return curState
        End Get
    End Property
    ...
    Public Property Title As String
        ...
        End Set
    End Property
    Public Property FormStyle As SlimOS_FormStyle
        Get
            Return fStyle
        End Get
    ...
    '        Return splitContent.Panel2.ClientSize.Height
    '    End Get
    ...
    '    Get
    '        On Error Resume Next
    '        Return splitContent.Panel2.ClientSize.Width
    '    End Get
    '    Set(value As Integer)
    '        On Error Resume Next
    ...
    Public Function GetScaleHeight() As Integer
        On Error GoTo tExit
        Return Me.splitContent.Panel2.Height
...
tExit:
    ...
    Public Function GetScaleWidth() As Integer
        On Error GoTo tExit
        Return Me.splitContent.Panel2.Width
    ...
    Private Sub SlimOS_Form_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        If hasLoaded = False Then
            Try
                ...
                Init()
            Catch ex As Exception
                Debug.Print("Exception has occurred. Details: " & ex.Message)
